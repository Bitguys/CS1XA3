...
def mainpage(request):
    return HttpResponseRedirect("https://mac1xa3.ca/u/guox54/project3.html")
...
def login(request):
    ...
    if request.method == 'POST':
        ...
        if user is None:
            ...
            return HttpResponse('Username:no exist or wrong password')
        else:
            login(request, user)
            return HttpResponse('Succeed' )

    else:
        return HttpResponseRedirect("https://mac1xa3.ca/u/guox54/sign_in.html")
